...
- Current tag: `v0.3.6`
- Current DMG asset: `SkillBox_0.3.6_universal.dmg`
- Current updater asset: `SkillBox_0.3.6_universal.app.tar.gz`
- Current updater signature: `SkillBox_0.3.6_universal.app.tar.gz.sig`
- Current updater manifest: `latest.json`
- Current checksum asset: `SkillBox_0.3.6_universal.dmg.sha256`
