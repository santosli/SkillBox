...
- Current tag: `v0.4.0`
- Current DMG asset: `SkillBox_0.4.0_universal.dmg`
- Current updater asset: `SkillBox_0.4.0_universal.app.tar.gz`
- Current updater signature: `SkillBox_0.4.0_universal.app.tar.gz.sig`
- Current updater manifest: `latest.json`
- Current checksum asset: `SkillBox_0.4.0_universal.dmg.sha256`
