...
- Current tag: `v0.3.4`
- Current DMG asset: `SkillBox_0.3.4_universal.dmg`
- Current updater asset: `SkillBox_0.3.4_universal.app.tar.gz`
- Current updater signature: `SkillBox_0.3.4_universal.app.tar.gz.sig`
- Current updater manifest: `latest.json`
- Current checksum asset: `SkillBox_0.3.4_universal.dmg.sha256`
